    ...
    <section className="relative mx-auto px-8 sm:px-16 lg:px-24">
      <div className="flex grid-cols-8 flex-col gap-8 lg:grid lg:gap-16">
        <div className="col-span-5">
          {/* <div className="bg-accentColor w-full aspect-video rounded-2xl"></div> */}
          <Image
        ...
        <div className="col-span-3 space-y-4 md:space-y-8">
          <Typography type="h1" className="font-display text-2xl font-bold text-accentColor lg:text-4xl" custom={true}>
            EIC Club
          </Typography>
