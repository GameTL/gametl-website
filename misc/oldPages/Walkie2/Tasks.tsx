...
function Task({ title, video, children: description }: { title: string; video: string; children: ReactNode }) {
  return (
    <div className="rounded-xl border border-gray-900 bg-backGroundColor px-4 py-6 shadow-sm">
      <div className="grid grid-cols-1 items-center gap-10 md:grid-cols-2">
        ...
        <div className="flex flex-col gap-4">
          <h2 className="text-4xl font-bold text-accentColor">{title}</h2>
  ...
  return (
    <section className="">
      ...
      <div className="mx-auto w-full max-w-5xl px-10 pb-8">
        <h1 className="mb-10 text-center text-6xl font-bold text-accentColor">Tasks</h1>
        <div className="flex flex-col gap-4">
      ...
      <div className="mx-auto w-full max-w-5xl px-10 pt-10 pb-8">
        <h1 className="mb-10 text-center text-6xl font-bold text-accentColor">Features</h1>
        <div className="flex flex-col gap-4">
      ...
      {/* <div className="h-48 bg-accentColor" /> */}
    </section>
  )
}
