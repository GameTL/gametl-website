...
function Card({ title, imgSrc, href }: CardProps) {
  return (
    <Link href={href} passHref>
      <a>
        <div className="max-w-96 h-full space-y-6 rounded-3xl border border-accentColor bg-accentColor p-4 transition-all hover:brightness-95 sm:p-8">
          <div className="overflow-hidden rounded-xl bg-backGroundColor">
