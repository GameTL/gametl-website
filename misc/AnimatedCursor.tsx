...
const config = {
  accentColor: "220, 90, 90",
  backGroundColor: "236, 231, 227",
}
...
export default function AnimatedCursor({
  ...
  useEffect(() => {
    const accentColorElements = document.querySelectorAll<HTMLElement>(".bg-accentColor")
    accentColorElements.forEach((el) => {
      el.style.cursor = "none"
      el.addEventListener("mouseover", () => {
